...
const IBlogo = () => {
  return (
    <div className={' w-full aspect-square' }>
        ...
        <svg className='dark:fill-slate-950 fill-white dark:stroke-white stroke-slate-950'  strokeWidth={12}  height="99%" width="99%" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	    viewBox="0 0 360 410" xml:space="preserve">
